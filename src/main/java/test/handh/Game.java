...
/**
 * Спроектируйте и реализуйте классы для одной видеоигры. Реализацию опубликуйте в открытом репозитории на github.
 ...
 * 3) У Существа есть Здоровье. Это натуральное число от 0 до N. Если Здоровье становится равным 0, то Существо умирает.
...
public class fight {
    ...
    public void fight(){
        int newHealth;
        int modification = attack - defense +1;
        int cube = 0;
        boolean flag = false;

        System.out.println("Атака: " + attack);
        System.out.println("Защита: " + defense);
        System.out.println("Начальное здоровье: " + health);
        System.out.println("Модификатор атаки: " + modification);
        ...
        if (modification > 0) {
            ...
            if (flag){
                    ...
                    System.out.println("Оставшееся здоровье:  " + newHealth);
                System.out.println("Продолжим битву?");
                System.out.println("Введи 0 - для выхода из игры");
